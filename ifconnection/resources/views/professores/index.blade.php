...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @else
                <p>Ainda não tem Disciplinas cadastradas!</p>
            @endif
        ...
        <div class="card-footer">
            ...
            @endif
            <td><a href="{{ route('materiasProfessor.create') }}" class="btn btn-primary">Vincular Disciplinas</a></td>
            <td><a href="{{ route('materiasProfessor.edit', ['userId' => $user->id]) }}" class="btn btn-primary">Editar Disciplinas</a></td>
